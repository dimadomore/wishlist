...
const HERO_TEXT =
  "Забронируй подарок, чтобы никто не подарил то же самое, — или скинься вместе с другими. " +
  "А если придумаешь что-то своё, чего здесь нет, — буду рад ничуть не меньше.";
